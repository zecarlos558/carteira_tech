...
const makeLink = function(mode) {
    ...
    let openLink = function() {
        ...
        target = '_blank'
        a.target = target
        a.href = mount() // o link URL do api.whatsapp.com
        ...
        //caminho = "C:/xampp/htdocs/samo_tech/samotech-isaStore/isa_store/public/test.txt"
