...
class MovimentoRendaController extends Controller
{
    ...
    {
        return redirect()->route('indexMovimento', ['tipo' => "suprimento"]);
    }
    ...
    public function create()
    {
        ...
        return view('movimento_renda.createMovimento', ['tipo_contas' => $tipo_contas,
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            Log::channel('main')->error($e->getMessage());
            return redirect()->route('editMovimentoRenda')->with('msg_alert','Campos Inseridos invalidos!');
        }
