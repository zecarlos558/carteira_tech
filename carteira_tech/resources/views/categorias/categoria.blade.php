                ...
                <x-div.row>
                    <x-div.col type="auto">
                        <div class="input-group">
                            ...
                            <x-input.text type="text" value="{{ old('descricao') }}" placeholder="Procurar categoria"
                    ...
                    <x-div.col type="auto">
                        <div class="input-group">
                            ...
                            <x-input.select id="grupo_id" name="grupo_id">
        ...
        <x-div.table>
            <x-table.thead>
                <x-table.tr>
                    ...
                    @if ($categorias->where('user_id_create', '=', auth()->user()->id)->isNotEmpty())
...
<x-div.paginacao :dados="$categorias"></x-div.paginacao>
