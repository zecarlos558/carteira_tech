<x-div.table-list>
    ...
    @slot('botao')
        <x-div.button>
            <x-button.a class="btn-primary create-btn" href="{{ route('createTipo') }}" role="button" icon='criar'>
        ...
        <x-table.tbody>
            @foreach ($tipos as $tipo)
                <x-table.tr>
                    ...
                    <x-table.td-button>
                        <x-div.button>
                            <x-button.a class="btn btn-info edit-btn" href="{{ route('editTipo', $tipo->id) }}"
